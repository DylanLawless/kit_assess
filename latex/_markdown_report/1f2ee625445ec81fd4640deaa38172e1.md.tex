...
\markdownRendererUlItem \textbf{Figures}: \ref{fig:p1}, \ref{fig:qualimap\markdownRendererEmphasis{gen}cov\markdownRendererEmphasis{hist}, and \ref{fig:qualimap}gen\markdownRendererEmphasis{cov}ref}.\markdownRendererUlItemEnd 
