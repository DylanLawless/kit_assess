...
\markdownRendererUlItem Data source: raw sequence data was received from [group and contact address].\markdownRendererUlItemEnd 
...
\markdownRendererUlItem Data integrity: [\href{https://github.com/DylanLawless/kit_assess/src/metadata/raw.md5sum}{linked metadata md5sum}].\markdownRendererUlItemEnd 
