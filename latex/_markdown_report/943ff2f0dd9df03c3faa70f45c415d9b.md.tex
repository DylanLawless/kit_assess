...
\markdownRendererUlEndTight \markdownRendererInterblockSeparator
{}\subsection{Configuration} * Local: macOS v11.6 * Remote: Red Hat Enterprise Linux Server 7.6 (Maipo) * R: R v4.1.0 Camp Pontanezen * fastqc: v0.11.7 * compiler intel: (19.0.5 and 19.1.1) * samtools: v1.10 * bwa: v0.7.17 * picard: v2.20.8 * R libraries: versions unlisted\relax