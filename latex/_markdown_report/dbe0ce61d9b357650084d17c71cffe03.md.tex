\section{Main files for technical writing report} This section contains the main information required for a technical report. The remainder of this document contains additional information, including duplicate reference to this files.\markdownRendererInterblockSeparator
{}\markdownRendererUlBeginTight
\markdownRendererUlItem Data source: all details from \ref{data_source}.\markdownRendererUlItemEnd 
\markdownRendererUlItem Protocol details: a hyperlink to the protocol source: [\href{https://github.com/DylanLawless/kit_assess/README.md}{link}].\markdownRendererUlItemEnd 
